    ...
    <>
      ...
      <main className="hero-underlap relative flex-1 bg-section-bg pt-8 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div 
            className="text-sm text-[#64748B] mb-10 flex flex-wrap items-center gap-2 animate-reveal-up"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 pb-16">
            {/* Image Column */}
            <div 
              className="bg-white rounded-4xl p-8 flex items-center justify-center border border-border h-[400px] lg:h-[650px] relative overflow-hidden group animate-reveal-up"
            >
            ...
            {/* Content Column */}
            <div 
              className="flex flex-col justify-center animate-reveal-up"
              style={{ animationDelay: '0.1s' }}
            >
              <span className="text-[#6CC24A] font-black tracking-[0.2em] uppercase text-xs mb-4">
                Berlington Model
              </span>
              
              <h1 className="text-4xl text-[#0F172A] font-black mb-6 tracking-tight leading-[1.1] md:text-5xl lg:text-6xl">
                {pump.fullName}
              </h1>
              
              <p className="text-lg md:text-xl text-[#475569] mb-10 leading-relaxed font-light">
              ...
              <div className="bg-white rounded-2xl p-8 border border-border mb-10 shadow-sm">
