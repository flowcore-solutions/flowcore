...
export function generateMetadata(): Metadata {
  return {
    ...
    openGraph: {
      ...
      url: "https://flowcore.in/berlington-pumps-bangalore",
...
const localBusinessSchema = {
  ...
  "@type": "LocalBusiness",
  "@id": "https://flowcore.in/berlington-pumps-bangalore#organization",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Berlington Pumps Bangalore", item: "https://flowcore.in/berlington-pumps-bangalore" },
  ],
};
