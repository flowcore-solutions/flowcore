...
const VERTICALS = [
  {
    ...
    tag: "WTP / RO",
    desc: "Multistage and transfer pumps for RO feed, filter feed, treated water transfer, and plant utility lines.",
    accent: "blue",
    icon: (
  ...
  },
  {
    ...
    title: "HVAC Systems",
    tag: "Climate Control",
    desc: "Inline and end-suction pumps for chilled water circulation, condenser loops, and cooling tower duty.",
    accent: "green",
    icon: (
      <svg className="w-full h-full" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    tag: "Municipal",
    desc: "Submersible pumps for STP wet wells, transfer lines, drainage pits, and wastewater movement.",
    accent: "blue",
    icon: (
      <svg className="w-full h-full" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    tag: "Chemical Focus",
    desc: "Pumps for chemical dosing, process transfer, pressure boosting, and plant utility water duty.",
    accent: "green",
    icon: (
      <svg className="w-full h-full" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="relative mx-auto max-w-7xl px-8 z-10">
        <div className="mb-16 flex flex-col md:flex-row md:items-end md:justify-between gap-8">
          <PrecisionReveal variant="fadeSlideLeft">
            ...
            >
              Industrial Pump <br className="hidden md:block" /> Applications
            </h2>
          </PrecisionReveal>
          ...
          <PrecisionReveal variant="fadeSlideRight" delay={0.1}>
            <p className="max-w-sm text-sm text-text-light md:text-right leading-relaxed font-medium">
              Real pump duties for RO plants, HVAC lines, STP transfer, pressure boosting, and plant utility water.
            </p>
          </PrecisionReveal>
        </div>
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col mt-auto">
                      <div className={`flex items-center text-[11px] font-bold transition-colors uppercase tracking-[0.15em] mb-2 ${ctaColorPrimary} ${ctaColorHover}`}>
                        View Duty
                        <svg className="ml-3 transition-transform duration-500 group-hover:translate-x-2" width="14" height="14" viewBox="0 0 16 16" fill="none">
