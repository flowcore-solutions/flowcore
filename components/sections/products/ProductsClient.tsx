...
/**
 * ProductsClient — all interactive filter/grid logic extracted from app/products/page.tsx
 * so the page file can remain a Server Component and export `metadata`.
 */
