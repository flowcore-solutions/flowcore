  ...
  return (
    <>
      <div className="fixed top-4 left-0 right-0 z-50 px-6 pointer-events-none">
        <motion.nav
          layout
          className={`relative mx-auto max-w-7xl rounded-4xl pointer-events-auto transition-all duration-500 ${
            scrolled
        ...
        >
          ...
          <div className="absolute inset-0 rounded-4xl overflow-hidden pointer-events-none">
            <div className="absolute top-1/2 -translate-y-1/2 -left-20 w-[24rem] h-96 bg-[#6CC24A]/25 blur-[60px] rounded-full" />
            <div className="absolute top-1/2 -translate-y-1/2 -right-20 w-120 h-120 bg-[#1E5BB8]/15 blur-[70px] rounded-full" />
          </div>
